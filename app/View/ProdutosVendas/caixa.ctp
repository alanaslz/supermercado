		...
		<div class="box box-solid">
            ...
            <div class="box-body">
				...
				<div class="form-group">
					<?php echo $this->Form->input('venda_id', array('class' => 'form-control', 'value'=>$venda_id, 'type'=>'hidden'));?>
				</div>
	...
	<div class="vendas  col-md-10 col-md-offset-1">
		...
		<tr>
		 ...
		 <td><?php echo $produto['ProdutosVenda']['qtd'] * $produto['ProdutosVenda']['preco_unit'] ;?> </td>
		  ...
		  <td> <?php echo $this->Form->postLink(__('Excluir'), array('action' => 'delete', $produto['ProdutosVenda']['id'],$venda_id), array('class' => 'btn btn-default btn-xs'), __('Confirma Exclusão do Registro # %s?', $produto['name'])); ?> </td>
