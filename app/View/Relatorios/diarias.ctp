	...
	<div class="actions col-md-12">
		<div class="box box-solid">
        	<div class="box-header with-border">
	            <h3 class="box-title"><?php echo __('Filtros - Relatório Geral de Diárias'); ?></h3>
	            <div class="box-tools">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                </div>
            </div>
            <?php echo $this->Form->create('Relatorio',array('action'=>'diarias')); ?>
			<div class="box-body">
...
<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo __('Relatório de Diárias');?></h3>
			</div>
            <div class="box-body">
	            <table class="table table-bordered">
					...
					<tr>
						<td><?php echo $diaria['Viagem']['name'];?>&nbsp;</td>
						<td><?php echo $diaria['Colaborador']['name'];?>&nbsp;</td>
						<td><?php echo $diaria['Diaria']['quantidade'];?>&nbsp;</td>
						<td><?php echo $diaria['Diaria']['valor'];?>&nbsp;</td>
						<td><?php echo $diaria['Diaria']['quantidade']*$diaria['Diaria']['valor'];?>&nbsp;</td>
						<td><?php echo $this->Html->link(__('Visualizar Detalhes'), array('controller'=>'viagens','action' => 'status', $diaria['Viagem']['id']), array('class' => 'btn btn-default btn-xs')); ?></td>
					</tr>
					<?php endforeach; 
						...
						<tr>
						<td colspan="6">
							Nenhuma diária encontrada! Verifique o filtro e tente novamente.
						</td>
