<div class="vendas index row">
	...
	<div class="box box-primary">
                <div class="box-header with-border">
	                 ...
	                 <h3 class="box-title"><?php echo __('SELECIONE UMA VENDA P/ CONTINUAR');?>
	                 
	                 <?php echo $this->Html->link(__('Iniciar Nova Venda'), array('controller'=>'vendas', 'action' => 'iniciar'), array('class' => 'btn btn-default btn-xs')); ?>
