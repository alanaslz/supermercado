...
<div class="actions col-md-10 col-md-offset-1">
	<div class="box box-solid">
                <div class="box-header with-border">
                 ...
                 <a class="btn btn-app" data-toggle="tooltip" data-placement="bottom" title="Adicionar Estado" href="<?php echo $this->Html->url(array('action' => 'add')); ?>"> <i class='fa fa-plus'></i> Estado </a>
...
<!--
				 ...
				 <a class="btn btn-app" href="<?php echo $this->Html->url(array('controller' => 'municipios','action' => 'index')); ?>"> <i class='fa fa-list'></i> Municipios </a>
				 
				  <a class="btn btn-app" href="<?php echo $this->Html->url(array('controller' => 'municipios','action' => 'add')); ?>"> <i class='fa fa-plus'></i> Municipio </a>
	...
	<div class="box box-primary">
                <div class="box-header with-border">
	                 ...
	                 <h3 class="box-title"><?php echo __('Estados');?></h3>
                </div>
                <div class="box-body">
	...
	<tr>
		...
		<td class="actions">
			<div class="btn-toolbar">
					<?php echo $this->Html->link(__('Visualizar'), array('action' => 'view', $estado['Estado']['id']), array('class' => 'btn btn-default btn-xs')); ?>
					<?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $estado['Estado']['id']), array('class' => 'btn btn-default btn-xs')); ?>
